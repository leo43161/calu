    ...
    <AnimatePresence>
      {visible && (
        <motion.a
          ...
          className="group fixed bottom-6 right-6 z-50 inline-flex items-center justify-center sm:justify-start gap-0 sm:gap-3 bg-deep-teal text-silk-cream h-14 w-14 sm:h-auto sm:w-auto sm:pl-4 sm:pr-5 sm:py-3 rounded-full shadow-[0_18px_40px_-12px_rgba(13,57,60,0.55)] hover:bg-leaf transition-colors duration-500"
        >
          {/* Halo */}
          ...
          <span className="relative flex items-center justify-center w-7 h-7 sm:w-9 sm:h-9 rounded-full text-antique-gold sm:bg-antique-gold sm:text-deep-teal">
            <svg
