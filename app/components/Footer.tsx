...
export function Footer() {
  return (
    <footer className="bg-paper border-t border-charcoal/10 px-6 lg:px-10 pt-24 pb-4">
      <div className="mx-auto max-w-7xl grid lg:grid-cols-12 gap-16">
        ...
        <div className="lg:col-span-6 space-y-6">
          ...
          <p className="text-steel font-normal max-w-md">
            Brindamos experiencias que combinan calma, calidez, bienestar y elegancia.
          </p>
        </div>
      ...
      <div className="mx-auto max-w-7xl mt-6 pt-4 border-t border-charcoal/10 flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="shrink-0 inline-flex items-center gap-2 text-sm text-deep-teal border border-deep-teal/40 px-5 py-1 rounded-full hover:bg-deep-teal hover:text-silk-cream transition-colors w-full sm:w-auto justify-center"
        >
          ...
          Escribime para tener tu página web
        </a>
      </div>
    </footer>
  );
